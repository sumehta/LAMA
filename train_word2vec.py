...
def main(args):
    ...
    model = gensim.models.Word2Vec(
        size=args.dim, min_count=10, workers=16, sg=1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='/home/sudo777/ASONAM/data/amazon')
    parser.add_argument('--data_dir', type=str, default='/home/sudo777/ASONAM/data/amazon', help='Location of the data corpus')
